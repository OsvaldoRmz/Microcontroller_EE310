...
#define RS LATDbits.LATD4                   /* PORTD 0 pin is used for Register Select */
#define EN LATDbits.LATD5                   /* PORTD 1 pin is used for Enable */
...
void LCD_Init(void){
    ...
    LCD_Control = 0xC0;    /* Set PORTD as output PORT LCD Control(RS,EN) Pins */
    TRISE = 0xFF;
    ANSELD = 0x00;
    ANSELB = 0x00;
    ANSELE = 0x00;
